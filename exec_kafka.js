...
services.set('server', exec('server', 'SPRING_PROFILES_ACTIVE=kafka node src/server.js'));
services.set('planner', exec('planner','SPRING_PROFILES_ACTIVE=kafka mvn spring-boot:run'));
